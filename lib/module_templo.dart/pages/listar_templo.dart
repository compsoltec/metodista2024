...
import 'package:metodista/module_templo.dart/controllers/templo_controllers.dart';
...
class _ListarTemploState extends State<ListarTemplo> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Obx(() => agendaTemploController.loading.value
            ? SizedBox(
                ...
                children: <Widget>[
                          ...
                          child: Align(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.quicksand(
                                    color:
                                        const Color.fromRGBO(45, 45, 42, 1.0),
                                    fontSize: 16,
                  ...
                  Expanded(
                      child: ListView.builder(
                          ...
                          itemCount:
                              agendaTemploController.agendatemploList.length,
