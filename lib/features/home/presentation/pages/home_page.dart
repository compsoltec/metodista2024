      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Stack(
              fit: StackFit
                  .expand, // Garante que os filhos preencham o Container
              children: [
                ClipRRect(
                  // Utiliza ClipRRect para respeitar os borderRadius
                  borderRadius: const BorderRadius.only(
                    bottomLeft: Radius.circular(40),
                    bottomRight: Radius.circular(40),
                  ),
                ...
                Container(
                  // Container para aplicar o gradiente sobre a imagem
                  decoration: BoxDecoration(
                    borderRadius: const BorderRadius.only(
                      bottomLeft: Radius.circular(40),
                      bottomRight: Radius.circular(40),
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        AppColors.gradientStart.withOpacity(
                            0.6), // Adiciona opacidade ao gradiente
