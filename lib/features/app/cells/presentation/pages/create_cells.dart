...
class CreateCellsScreen extends StatefulWidget {
  const CreateCellsScreen({super.key});

  @override
  State<CreateCellsScreen> createState() => _CreateCellsScreenState();
}

class _CreateCellsScreenState extends State<CreateCellsScreen> {
  ...
  final CellsBloc _courcesBloc = GetIt.instance<CellsBloc>();
  ...
  void _submitForm() {
    ...
    _courcesBloc.add(CreateCells(cells));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<CellsBloc, CellsState>(
        bloc: _courcesBloc,
        listener: (context, state) {
          if (state is CellsSuccess) {
            setState(() {
              _isLoading = false;
            });
            ScaffoldMessenger.of(context).showSnackBar(
